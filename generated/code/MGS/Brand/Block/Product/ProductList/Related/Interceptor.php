...
class Interceptor extends \MGS\Brand\Block\Product\ProductList\Related implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Magento\Framework\Registry $registry, \MGS\Brand\Helper\Data $brandHelper, \MGS\Brand\Model\Brand $brand, \Magento\Store\Model\StoreManagerInterface $storeManager, \Magento\Catalog\Model\ResourceModel\Product\CollectionFactory $productCollectionFactory, \Magento\Catalog\Model\Product\Visibility $catalogProductVisibility, \Magento\Framework\App\Http\Context $httpContext, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $registry, $brandHelper, $brand, $storeManager, $productCollectionFactory, $catalogProductVisibility, $httpContext, $data);
    }
    ...
    public function getBrand()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getBrand', func_get_args(), $pluginInfo) : parent::getBrand();
    }
